...
public class PhieuNhapGUI extends javax.swing.JPanel {
    ...
    PhieuNhapBUS spBUS = new PhieuNhapBUS();
    ...
    private void loadDataLenBangPhieuNhap() {
        ...
        ArrayList<NhapHang> dssp = spBUS.getListPhieuNhap();
        DecimalFormat dcf = new DecimalFormat("###,###");

        Object obj[] = new Object[5];
        for (NhapHang sp : dssp) {
            obj[0] = sp.getMaPN();
            obj[1] = sp.getMaNCC();
            obj[2] = sp.getMaNV();
            obj[3] = sp.getNgayLap();
    ...
    private void loadDataLenBangCTPhieuNhap() {
        ...
        dtmSanPham.setRowCount(0);
        ArrayList<CTPhieuNhap> dssp = spBUS.getListCTPhieuNhapTheoMa(txtMaPNCT.getText(), txtMaSP.getText());
        DecimalFormat dcf = new DecimalFormat("###,###");
        ...
        for (CTPhieuNhap sp : dssp) {
            ...
            obj[1] = sp.getMaSP();
            obj[2] = sp.getSoLuong();
            obj[3] = dcf.format(sp.getThanhTien());
            dtmSanPham.addRow(obj);
        }
    }
     ...
     private void xuLyClickTblPhieuNhap() {
        ...
        if (row > -1) {
            ...
            dtmSanPham = (DefaultTableModel) setMyTable1().getModel();
            dtmSanPham.setRowCount(0);
            ArrayList<CTPhieuNhap> dssp = spBUS.getListCTPhieuNhapTheoMa(maPN);
            DecimalFormat dcf = new DecimalFormat("###,###");
