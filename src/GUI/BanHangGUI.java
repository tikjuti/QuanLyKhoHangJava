...
public class BanHangGUI extends javax.swing.JPanel {
    ...
    BanHangBUS pnBUS = new BanHangBUS();
                ...
                .addGroup(pnListPhieuNhapLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnListPhieuNhapLayout.createSequentialGroup()
                        ...
                        .addGroup(pnListPhieuNhapLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cmbTNCC, 0, 154, Short.MAX_VALUE)
    ...
    private void loadDataCmbNCC() {
        ...
        ArrayList<KhachHang> dsl = nccBUS.getListKhachHang();
        for (KhachHang loai : dsl) {
            cmbTNCC.addItem(loai.getMaKH() + " - " + loai.getTenKH());
        }
    }
    ...
    private void xuLyThanhToan() {
        ...
        if (n == JOptionPane.OK_OPTION) {
            boolean pn = pnBUS.themPhieuNhap(manv, ncc, tongtien);
            ...
            for (int i = 0 ; i < rowPN ;i ++) {
                ...
                pnBUS.themCTPhieuNhap(maSP, idPN, sl, tt);
            }
            if (pn) {
